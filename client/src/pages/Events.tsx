  ...
  return (
    <div style={{ backgroundColor: "#1a1410", minHeight: "100vh" }}>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(https://placehold.co/1200x800/2a2118/c8b89a?text=Abbey+Pub)`,
          ...
          <div className="mb-12">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <button onClick={prevMonth} className="p-2 transition-colors" style={{ color: "#c8b89a" }}
                ...
                <button onClick={nextMonth} className="p-2 transition-colors" style={{ color: "#c8b89a" }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = "#d4820a")}
                  onMouseLeave={(e) => (e.currentTarget.style.color = "#c8b89a")}
                >
